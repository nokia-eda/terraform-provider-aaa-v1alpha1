...
const (
	create_rs_nodeGroup = "/apps/aaa.eda.nokia.com/v1alpha1/namespaces/{namespace}/nodegroups"
	read_rs_nodeGroup   = "/apps/aaa.eda.nokia.com/v1alpha1/namespaces/{namespace}/nodegroups/{name}"
	update_rs_nodeGroup = "/apps/aaa.eda.nokia.com/v1alpha1/namespaces/{namespace}/nodegroups/{name}"
	delete_rs_nodeGroup = "/apps/aaa.eda.nokia.com/v1alpha1/namespaces/{namespace}/nodegroups/{name}"
)
